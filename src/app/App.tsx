...
function HeroSection() {
  ...
  useEffect(() => {
    const update = () => {
      ...
      if (tablet) {
        setPhoneScale(mobile ? Math.min(1, (width - 96) / 370) : TABLET_PHONE_SCALE);
      } else {
...
function SectionText({ title, body, items }: { title: string; body: string; items: string[] }) {
  return (
    <div className="flex flex-col gap-[24px] min-[1280px]:gap-[32px] items-start flex-1 min-w-0 w-full">
      ...
      <p className="font-['Roboto',sans-serif] font-normal text-[#4a4459] text-[20px] leading-[28px] min-[1280px]:text-[22px] min-[1280px]:leading-[28px]">
        {body}
      </p>
    ...
    <section id="contact" className="bg-white py-[72px] min-[1280px]:py-[80px]">
      ...
      <Container>
        <div className="max-w-[600px] mx-auto flex flex-col gap-[32px] items-center">
          ...
          <p className="font-['Roboto',sans-serif] font-normal text-[#4a4459] text-[20px] leading-[28px] min-[1280px]:text-[22px] min-[1280px]:leading-[28px] text-center">
